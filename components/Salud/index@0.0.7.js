...
const news = window.news || [
  {
    "title": "¿Cómo educar niños felices?",
    "summary": "Criar niños felices, no es una tarea fácil.  Por eso, hablamos con el  Dr. Alfonso Correa, psiquiatra infanto-juvenil de nuestra clínica, para conocer sus consejos.",
    "publicationDate": "10/04/2023",
    "navigateUrl": "https://www.clinicaalemana.cl/new-home/2023/como-educar-ninos-felices",
    "readingTime": "3",
    "photo": "https://d51h1y0hva8v.cloudfront.net/images/default-source/art%C3%ADculos/gettyimages-1069283718-(1)-(1).jpg?sfvrsn=afae0eda_1",
    "categories": [
      {
        "title": "Niñas, niños y adolescentes",
        "url": "https://www.clinicaalemana.cl/articulos/todas-las-noticias/ni&#241;as-ni&#241;os-y-adolescentes"
      }
    ],
    "tags": [
      {
        "title": "calidad de vida",
        "url": "https://www.clinicaalemana.cl/articulos/todas-las-noticias/calidad-de-vida"
      },
      {
        "title": "Niños",
        "url": "https://www.clinicaalemana.cl/articulos/todas-las-noticias/ninos"
      },
      {
        "title": "salud mental",
        "url": "https://www.clinicaalemana.cl/articulos/todas-las-noticias/salud-mental"
      }
    ]
  },
  {
    "title": "5 consejos para comer bien en Semana Santa",
    "summary": "Hablamos con la nutricionista Andrea Valenzuela para darte algunas recomendaciones para cuidar de tu salud y la de tu familia durante estas celebraciones.",
    "publicationDate": "06/04/2023",
    "navigateUrl": "https://www.clinicaalemana.cl/new-home/2023/5-consejos-para-comer-bien-en-semana-santa",
    "readingTime": "3",
    "photo": "https://d51h1y0hva8v.cloudfront.net/images/default-source/art%C3%ADculos/gettyimages-921672530-(1)-(1).jpg?sfvrsn=9c8efe5_1",
    "categories": [
      {
        "title": "Alimentación y nutrición",
        "url": "https://www.clinicaalemana.cl/articulos/todas-las-noticias/alimentaci&#243;n-y-nutrici&#243;n"
      }
    ],
    "tags": [
      {
        "title": "alimentación saludable",
        "url": "https://www.clinicaalemana.cl/articulos/todas-las-noticias/alimentacion-saludable"
      }
    ]
  },
  {
    "title": "¿Cómo saber si tengo una enfermedad de transmisión sexual (ETS)?",
    "summary": "Según la OMS, 1 millón de personas diariamente se contagia de alguna ETS. Por este motivo, queremos que conozcas cómo prevenirlas y cómo saber si tienes una.",
    "publicationDate": "03/04/2023",
    "navigateUrl": "https://www.clinicaalemana.cl/new-home/2023/como-saber-si-tengo-una-ets",
    "readingTime": "1",
    "photo": "https://d51h1y0hva8v.cloudfront.net/images/default-source/art%C3%ADculos/gettyimages-1083336694-(1)-(1).jpg?sfvrsn=66955900_1",
    "categories": [
      {
...
class CasSalud extends LitElement {
  ...
  constructor() {
    ...
    this.selected = {};
    this.list = [];
    this.disabledLeft = true; //button left
    this.disabledRight = false; //button right
    this.hasNextFilter = false; //tag
    this.hasPrevFilter = false; //tag
  }
  ...
  connectedCallback() {
    ...
    const modifiedKeys = news.map((item) => {
      ...
      const image = `https://res.cloudinary.com/spacexdw/image/fetch/f_auto,q_100,c_thumb,g_faces,w_350,h_250/${photo}`
      return {
        image,
        tags: categories,
        title,
  ...
  firstUpdated() {
    ...
    actions.addEventListener("clickLeft", () => list.scrollLeft -= 300)
    actions.addEventListener("clickRight", () => list.scrollLeft += 300)

    list.addEventListener("scroll", (e) => {
      const { scrollLeft, scrollWidth, clientWidth } = e.target;
      const maxScroll = scrollWidth - clientWidth;
      if (scrollLeft > 0) this.disabledLeft = false;
      if (scrollLeft === 0) this.disabledLeft = true;
      if (scrollLeft < maxScroll) this.disabledRight = false;
      if (scrollLeft === maxScroll) this.disabledRight = true;
      this.requestUpdate();
    });
