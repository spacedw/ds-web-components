...
const alliances = [
  "https://d51h1y0hva8v.cloudfront.net/images/default-source/dai/alianzas/al1.png",
  "https://d51h1y0hva8v.cloudfront.net/images/default-source/dai/alianzas/al2.png",
  "https://d51h1y0hva8v.cloudfront.net/images/default-source/dai/alianzas/al3.png",
  "https://d51h1y0hva8v.cloudfront.net/images/default-source/dai/alianzas/al4.png",
]
const stylesDAI = css`
  :host {
    display: flex;
...
class MyComponent extends LitElement {
  ...
  render() {
    ...
    const renderAlliances = alliances.map((item) => {
      return html`<div class="image"><img src="https://res.cloudinary.com/spacexdw/image/fetch/f_auto,q_100/${item}" alt="Alianza" /></div>`
    });
    return html`
